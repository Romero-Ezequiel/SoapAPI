...
namespace CalculatorReference
{
    ...
    public interface CalculatorSoap
    {
        ...
        CalculatorReference.AddResponse Add(CalculatorReference.AddRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Add", ReplyAction="*")]
        System.Threading.Tasks.Task<CalculatorReference.AddResponse> AddAsync(CalculatorReference.AddRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Subtract", ReplyAction="*")]
        CalculatorReference.SubtractResponse Subtract(CalculatorReference.SubtractRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Subtract", ReplyAction="*")]
        System.Threading.Tasks.Task<CalculatorReference.SubtractResponse> SubtractAsync(CalculatorReference.SubtractRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Multiply", ReplyAction="*")]
        CalculatorReference.MultiplyResponse Multiply(CalculatorReference.MultiplyRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Multiply", ReplyAction="*")]
        System.Threading.Tasks.Task<CalculatorReference.MultiplyResponse> MultiplyAsync(CalculatorReference.MultiplyRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Divide", ReplyAction="*")]
        CalculatorReference.DivideResponse Divide(CalculatorReference.DivideRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Divide", ReplyAction="*")]
        System.Threading.Tasks.Task<CalculatorReference.DivideResponse> DivideAsync(CalculatorReference.DivideRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface CalculatorSoapChannel : CalculatorReference.CalculatorSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class CalculatorSoapClient : System.ServiceModel.ClientBase<CalculatorReference.CalculatorSoap>, CalculatorReference.CalculatorSoap
    {
        ...
        public CalculatorReference.AddResponse Add(CalculatorReference.AddRequest request)
        {
            return base.Channel.Add(request);
        }
        
        public System.Threading.Tasks.Task<CalculatorReference.AddResponse> AddAsync(CalculatorReference.AddRequest request)
        {
            return base.Channel.AddAsync(request);
        }
        
        public CalculatorReference.SubtractResponse Subtract(CalculatorReference.SubtractRequest request)
        {
            return base.Channel.Subtract(request);
        }
        
        public System.Threading.Tasks.Task<CalculatorReference.SubtractResponse> SubtractAsync(CalculatorReference.SubtractRequest request)
        {
            return base.Channel.SubtractAsync(request);
        }
        
        public CalculatorReference.MultiplyResponse Multiply(CalculatorReference.MultiplyRequest request)
        {
            return base.Channel.Multiply(request);
        }
        
        public System.Threading.Tasks.Task<CalculatorReference.MultiplyResponse> MultiplyAsync(CalculatorReference.MultiplyRequest request)
        {
            return base.Channel.MultiplyAsync(request);
        }
        
        public CalculatorReference.DivideResponse Divide(CalculatorReference.DivideRequest request)
        {
            return base.Channel.Divide(request);
        }
        
        public System.Threading.Tasks.Task<CalculatorReference.DivideResponse> DivideAsync(CalculatorReference.DivideRequest request)
        {
